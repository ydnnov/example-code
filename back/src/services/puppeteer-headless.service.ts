...
import puppeteer, { Browser, ElementHandle, HTTPResponse, KeyInput, Page, PuppeteerLaunchOptions } from 'puppeteer';
...
export class PuppeteerHeadlessService extends HeadlessService {
